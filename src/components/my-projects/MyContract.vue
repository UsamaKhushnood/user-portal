<template>
  <div class="col-12 tab-sec-ticket tab-not">
    ...
    <div class="tab-content" v-for="(job, jobIndex) in jobList" :key="jobIndex" v-b-modal="'my-contracts-job-view' + jobIndex">
...
<script>
import ViewJobModal from "./modals/my-contracts-modals/ViewJobModal";
export default {
