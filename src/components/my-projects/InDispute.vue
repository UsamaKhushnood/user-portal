    ...
    <div class="tab-content">
      <div class="tab-pane show active">
        <div
          ...
          :key="projectIndex"
          v-b-modal="'view-disputed-job' + projectIndex"
        >
          <div class="task-content ticket-prgs-common">
            ...
            <div class="tckt-t-w">
              ...
              <span class="c-green">{{ job.status }}</span>
            </div>
          </div>
          ...
          <ViewDisputedJobModal :job="projectIndex"></ViewDisputedJobModal>
        </div>
      </div>
    </div>
  </div>
...
<script>
import ViewDisputedJobModal from "./modals/in-dispute-modals/ViewDisputedJobModal";
export default {
  components: { ViewDisputedJobModal },
  data() {
    return {
      jobsList: [
        {
