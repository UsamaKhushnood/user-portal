              ...
              <div class="col-xl-12 col-12">
                <div class="pane-common-inner">
                  <div class="task-content-row">
                    ...
                    <div
                      class="
                        pt-mlstn-container pt-mlstn-request-container
                        s-pad
                      "
                    >
                      <div
                      ...
                      >
                        ...
                        <div class="pt-mlstn-common pt-mlstn-view text-center">
                          <div class="view-c-d">
                            <span>2</span>
                            <svg class="">
                              <use xlink:href="#document"></use>
...
<script>
export default {
  props: ["projectTaskIndex", "jobIndex", "category", "sub_category", "task"],
};
</script>