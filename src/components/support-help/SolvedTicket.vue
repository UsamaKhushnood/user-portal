    ...
    <div class="tab-content">
      <div class="tab-pane show active">
        <div
          ...
          :key="ticketIndex"
          v-b-modal="'solved-ticket-modal' + ticketIndex"
        >
          ...
          <SolvedTicketModal :index="ticketIndex"></SolvedTicketModal>
        </div>
      </div>
...
<script>
import SolvedTicketModal from "./modals/solved-ticket-modals/SolvedTicketModal.vue";
export default {
  components: { SolvedTicketModal },
  data() {
    return {
      tickets: [
        {
