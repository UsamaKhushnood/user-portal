<template>
  <div>
    <b-modal :id="'ticket-progress-modal' + index" size="xl" hide-footer hide-header>
      <template #default="{ close }">
        <div class="modal-content">
          ...
          <div class="ui-block padd-all-10 message-block">
            <div class="message-b-com">
            ...
            <div class="message-b-com msg-buttons">
              <button
                class="
                  btn btn-primary btn-lg
                  full-width
                  c-form-btn
                  btn-msg-common btn-msg-attach
                "
                data-toggle="modal"
                data-target="#ticket-attach"
              >
                <svg class="btn-msg-icon">
