    ...
    <div class="tab-content">
      <div class="tab-pane show active">
        <div
          ...
          :key="ticketIndex"
          v-b-modal="'ticket-progress-modal' + ticketIndex"
        >
          <div class="task-content ticket-prgs-common">
            ...
            <div class="task-ctnt-common task-det">
              <span>Ticket ID: {{ ticketIndex }}</span>
            </div>
            <div class="task-ctnt-common task-det text-center">
              <span>{{ ticket.title }}</span>
            </div>
            <div class="task-ctnt-common task-det text-center">
              <span>{{ ticket.dateAndTime }}</span>
            </div>
          ...
          <TicketProgressModal :index="ticketIndex"></TicketProgressModal>
        </div>
      </div>
    </div>
  </div>
...
<script>
import TicketProgressModal from "./modals/ticket-progress-modals/TicketProgressModal.vue"
export default {
    components: { TicketProgressModal },
  data() {
    return {
      tickets: [
        {
