<template>
  <div>
    <div class="row t-container tab-pane active" id="tab-2-3">
        ...
        <div class="tab-content">
          <div class="tab-pane show active">
            ...
            <div
              ...
              v-b-modal="'work-interview-modal'"
            >
              ...
              <div class="job-srch-btm-wrapper">
                <span>Status : <font class="c-blue">Open</font></span>
                <span>Notification : <font class="c-green">yes</font></span>
              </div>
              <WorkInterviewModal></WorkInterviewModal>
            </div>
          </div>
        </div>
      </div>
...
<script>
import WorkInterviewModal from "./modals/work-interview-modals/WorkInterviewModal.vue"
export default {
    components: { WorkInterviewModal }
}
</script>