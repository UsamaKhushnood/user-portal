<template>
  <div>
    <div class="row t-container tab-pane active" id="tab-2-6">
        ...
        <div class="tab-content">
          <div class="tab-pane show active">
            ...
            <div
              ...
              data-toggle="modal"
              data-target="#int-reject"
              v-b-modal="'rejected-work-modal'"
            >
              ...
              <div class="job-srch-btm-wrapper">
                <span>Status : <font class="c-red">Rejected</font></span>
                <span
                  >Reason :
                  <font class="c-red"
                    >Need another Time and another Date</font
                  ></span
                >
              </div>
              <RejectedWorkModal></RejectedWorkModal>
            </div>
          </div>
        </div>
      </div>
...
<script>
import RejectedWorkModal from "./modals/rejected-modals/RejectedWorkModal.vue"
export default {
    components: { RejectedWorkModal }
}
</script>