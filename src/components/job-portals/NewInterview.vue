<template>
  <div>
    <div class="row t-container tab-pane active" id="tab-2-4">
        ...
        <div class="tab-content">
          <div class="tab-pane show active">
            ...
            >
              ...
              <NewInterviewModal></NewInterviewModal>
            </div>
          </div>
        </div>
      </div>
...
<script>
import NewInterviewModal from "./modals/new-interview-modals/NewInterviewModal.vue"
export default {
    components: { NewInterviewModal }
}
</script>