        ...
        >
          <div class="task-content ticket-prgs-common">
            ...
            <div class="task-ctnt-common task-det">
              <span class="stm-cont-h">{{ purchasedIndex }}: Purchase ID</span>
              <span>{{ purchasedItem.purchaseId }}</span>
            </div>
            <div class="task-ctnt-common task-det">
              <span class="stm-cont-h">Purchase Title</span>
              <span>{{ purchasedItem.title }}</span>
            </div>
            <div class="task-ctnt-common task-det">
              <span class="stm-cont-h">Purchase Date</span>
              <span>{{ purchasedItem.purchaseDate }}</span>
            </div>
