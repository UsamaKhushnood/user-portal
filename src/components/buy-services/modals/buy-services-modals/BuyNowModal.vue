    ...
    >
      <template #default="{ close }">
        <div class="modal-content">
          ...
          <ul class="nav nav-tabs nav-justified nav-crt">
            <li class="nav-item">
              <a
                class="nav-link"
                data-toggle="tab"
            ...
            <li class="nav-item">
              <a
                ...
                data-toggle="tab"
                href="#tab-buy-2-2"
                :class="[{ active: $route.hash === '#tab-buy-2-2' }]"
                >Checkout</a
              >
            </li>
          </ul>
          <div class="modal-body modal-body-bap">
            <form class="custom-form tab-content no-bg no-shadow">
              ...
              >
                <div
                  class="row mx-0 pt-4 px-2"
                  style="background-color: #edf2f6"
                >
                  <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                    <div class="sd-block">
                      <div class="sd-block-wrapper">
                        <div class="continue-shopping">
                          <a href="#">Continue Shopping</a>
                        </div>
                        <div class="ui-block discount-code">
                          ...
                          <div class="discount-code-input">
                            ...
                            />
                            <button class="disc-apply" type="submit">
                              Apply
                            </button>
                          </div>
                        </div>
                    ...
                    <div class="ui-block">
                      <div class="cte-milestone">
                        <div class="cte-milestone-com cte-milestone-icon">
                          <svg class="">
                            <use xlink:href="@/assets/svg-sprite.svg#shopping-cart-1"></use>
                          </svg>
                        </div>
                        <div class="cte-milestone-com">
                          <span class="cte-milestone-h">Purchase Title</span>
                          <span class="cte-milestone-sub"
                            >Car Service for Free</span
                          >
                        </div>
                        <div class="cte-milestone-com">
                          <span class="cte-milestone-price">29,99 €</span>
                        </div>
                        <div class="cte-milestone-com">
                          <span class="cte-milestone-h">Discount</span>
                          <span class="cte-milestone-sub">- 10 % - 2,99 €</span>
                        </div>
                        <div class="cte-milestone-com">
                          <span class="cte-milestone-price">27,00 €</span>
                        </div>
                      </div>
                    </div>
                    <div class="ui-block">
                    ...
                    <div class="ui-block single-img-center">
                      ...
                      <span class="si-txt"
                        >Your Cart is empty start add items</span
                      >
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div class="ui-block">
                      <div class="your-profile">
                        <div class="rt-panel-h">Cart</div>
                        <div class="cart-det-row">
                          <span class="cart-det-h">Total</span>
                          <div class="cart-det-txt-row">
                            <span class="cart-det-txt-left"></span>
                            <span class="cart-det-txt-right">27,00 €</span>
                          </div>
                        </div>
                        <div class="cart-det-row">
                          <span class="cart-det-h">Portal Fee</span>
                          <div class="cart-det-txt-row">
                            <span class="cart-det-txt-left">+ 10%</span>
                            <span class="cart-det-txt-right">+ 2,99 €</span>
                          </div>
                        </div>
                        <div class="cart-det-row">
                          <span class="cart-det-h">Subtotal</span>
                          <div class="cart-det-txt-row">
                            <span class="cart-det-txt-left"></span>
                            <span class="cart-det-txt-right">29,99 €</span>
                          </div>
                        </div>
                        <div class="cart-det-row">
                          <span class="cart-det-h">Total Net 19%</span>
                          <div class="cart-det-txt-row">
                            <span class="cart-det-txt-left">17,24 €</span>
                            <span class="cart-det-txt-right">- 90,72 €</span>
                          </div>
                        </div>
                        <div class="cart-det-row">
                          <span class="cart-det-h">Total to Pay</span>
                          <div class="cart-det-txt-row">
                            <span class="cart-det-txt-left"></span>
                            <span class="cart-det-txt-right">107,96 €</span>
                          </div>
                        </div>
                        <div class="cart-ckot-btn">
                          <a href="#" class="cart-ckot pop-over">Checkout</a>
                        </div>
                        <!---->
                      </div>
                    </div>
                  ...
                  <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                    <div class="ui-block">
                      <div class="discount-code">
                        <div class="discount-code-title">How to Pay</div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-4 col-md-4 col-sm-12">
                        <div class="shipping-box">
                          ...
                          <div class="shipping-box-inner">
                            <img src="@/assets/img/world-dark.svg" alt="" />
                            <p>Worldwide</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-4 col-md-4 col-sm-12">
                        <div class="shipping-box">
                          <input type="radio" name="shipping_method" />
                          <div class="shipping-box-inner">
                            <img src="@/assets/img/usps.svg" alt="" />
                            <p>Usps</p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="ui-block s-in-up-block">
                          <a href="#" class="s-in-up">Sign In</a>
                          <a href="#" class="s-in-up">Sign Up</a>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-12 go-pay-trigger">
                        <a
                          class="pop-over crsr-pntr"
                          data-toggle="modal"
                          data-target="#payment-pay"
                          v-b-modal="'go-to-payment-page-modal' + productIndex"
                          >Go to Payment Page
                          <GoToPaymentPageModal :productIndex="productIndex"></GoToPaymentPageModal>
                          </a
                        >
                      </div>
                    </div>
...
<script>
import GoToPaymentPageModal from "./GoToPaymentPageModal";
export default {
    components: { GoToPaymentPageModal },
  props: ["productIndex"],
};
</script>