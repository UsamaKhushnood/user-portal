<template>
  <div>
    <b-modal
      :id="'confirm-payment-modal' + productIndex"
      size="xl"
      hide-header
      hide-footer
    >
          ...
          <div class="modal-body modal-body-bap bg-white">
            <form class="custom-form tab-content no-bg no-shadow">
              <div class="shop-wrapper">
                <!--Header-->
                <div class="cart-container is-payment" style="display: none">
                ...
                >
                  ...
                  <div class="left">
                    <div class="left-header">
                      <div class="header-inner">
                        <img class="avatar" src="img/store.svg" alt="image" />
                ...
                <div id="confirmation-container" class="checkout-container">
