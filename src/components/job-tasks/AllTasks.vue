      ...
      <div class="col-12 t-c-row-all-r-c">
        ...
        >
          <div class="task-content ticket-prgs-common">
            ...
            <div class="task-ctnt-common task-det text-center">
              <span class="stm-cont-h">Status</span>
              <span class="c-blue" v-if="task.status == 'In Waiting'">{{
                task.status
              }}</span>
              <span class="c-orange" v-if="task.status == 'In Check'">{{
                task.status
              }}</span>
              <span class="c-red" v-if="task.status == 'In Hold'">{{
                task.status
              }}</span>
              <span class="c-green" v-if="task.status == 'Done'">{{
                task.status
              }}</span>
            </div>
            <div class="task-ctnt-common task-det text-center">
            ...
            <div class="task-ctnt-common task-det text-center tsk-more-det">
              <a href="#" v-b-modal.view-in-progress0>More Details</a>
            </div>
          </div>
        </div>
      </div>
...
<script>
import ViewInProgressModal from "./modals/in-progress-modals/ViewInProgressModal";
export default {
  components: { ViewInProgressModal },
  data() {
    return {
      taskList: [
        {
