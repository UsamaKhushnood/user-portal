    ...
    <div class="container tab-content-parent">
      <div class="row">
        <div class="col col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
            ...
            <div class="row">
              <div class="col col-12">
                ...
                <ul class="nav nav-tabs nav-justified">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#tab-2-5f"
                      >In Faild</a
                    >
                  </li>
                  <li class="nav-item">
          ...
          <div class="ui-block">
            <div class="your-profile">
              ...
              <div class="ststc">
                <span class="ststc-h">Total Added Jobs</span>
                <span class="c-green">30</span>
              </div>
              <div class="ststc">
                <span class="ststc-h">Jobs totaly done</span>
                <span class="c-green">25</span>
              </div>
              <div class="ststc">
                <span class="ststc-h">Jobs Failed total</span>
                <span class="c-red">5</span>
              </div>
              <div class="ststc">
                <span class="ststc-h">Hiring Total</span>
        ...
        >
          ...
          <div class="row t-container tab-pane" id="tab-2-4">
            <div class="col-12 tab-sec-ticket tab-not">
              ...
              <div class="task-content ticket-prgs-common">
                ...
                <div class="tckt-t-w tckt-vwc-btn">
                  <button
                    class="btn btn-lg btn-green pop-over"
                    data-dismiss="modal"
                    aria-label="Close"
                    data-toggle="modal"
                    data-target="#in-done-v-contract"
                  >
                    View Contract
                  </button>
                </div>
              ...
              <div class="task-content ticket-prgs-common">
                ...
                <div class="tckt-t-w tckt-vwc-btn">
                  <button class="btn btn-lg btn-green">View Contract</button>
                </div>
                <div class="tckt-t-w tckt-t-w-btn">
                  <button
                    class="btn btn-lg btn-green pop-over"
          ...
          <div class="row t-container tab-pane" id="tab-2-5f">
            <div class="col-12 tab-sec-ticket tab-not">
              <div class="filter-common">
                <div class="filter-inner-comon"><span>Filter</span></div>
                <div class="filter-inner-comon">
