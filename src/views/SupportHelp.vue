    ...
    <div class="row">
        <div class="col col-12">
            ...
            <ul class="nav nav-tabs nav-justified">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#tab-2-1">Create ticket</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#tab-2-2">Ticket in Progress</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#tab-2-3">Solved Ticket</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#tab-2-4">Closed Tickets</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="ui-block">
    <div class="your-profile">
        ...
        <div class="ststc">
            <span class="ststc-h">Total Tickets</span>
            <span class="c-green">100</span>
        </div>
        <div class="ststc">
            <span class="ststc-h">Tickets in Progress</span>
            <span class="c-green">25</span>
        </div>
        <div class="ststc">
            <span class="ststc-h">Solved Tickets</span>
            <span class="c-red">5</span>
        </div>
        <div class="ststc">
            <span class="ststc-h">Closed Tickets</span>
        ...
        <div class="col col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 tab-content tab-content-nbg">
            <div class="row t-container tab-pane show active" id="tab-2-1">
                <div class="col-12 tab-sec-ticket tab-not">
                    <div class="sh-ct-container">
                        <div class="sh-ct-inner">
                            <span class="sh-ct-title">Open Ticket for Add Services</span>
                            <span>Claim for Services u add , or Jobs Search or else</span>
                        </div>
                        <div class="sh-ct-inner">
                            <span class="sh-ct-title">Open Ticket for Mainsystem</span>
                            <span>Claim for Purchse Services, or Projects Asigments</span>
                        </div>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab-1-1">
                            <div class="ui-block">
                                <div class="ui-block-content ui-block-padd ui-block-user">
                                    <!-- Personal Information Form  -->
                                    <div class="row upload-r upload-r-user">
                                        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group label-floating">
                                                ...
                                                <div class="select-dd-active">
                                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="255px" height="255px" viewBox="0 0 255 255" style="enable-background:new 0 0 255 255;" xml:space="preserve"><g><g id="arrow-drop-down"><polygon points="0,63.75 127.5,191.25 255,63.75   "></polygon></g>
                                ...
                                <div class="ui-block-content ui-block-padd ui-block-user">
                                    ...
                                    <div class="row upload-r upload-r-user">
                                        ...
                                        <div class="col col-sm-12 col-12">
                                            <div class="form-group label-floating form-group-textare">
                                    ...
                                    <div class="row upload-r upload-r-u-up">
                                    ...
                                    <div class="col col-12 text-center">
                                        <button class="btn btn-primary btn-lg c-form-btn btn-custom-primary">Open a Ticket</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="task-content ticket-prgs-common">
                                    ...
                                    <div class="tckt-ctnt-common tckt-avatar">
                                        <div class="tckt-author-thumb">
                                            ...
                                            <span class="icon-status online" style="width: 15px; height: 15px;"></span>
                                        </div>
                                    </div>	
                                </div>
                            </div>
                        ...
                        <div class="tab-pane show active">
                            <div class="task-content-row">
                                <div class="task-content ticket-prgs-common">
                                    ...
                                    <div class="task-ctnt-common task-det text-center">
                                        <span class="c-red">Date and Time</span>
                                    </div>
                                    <div class="task-ctnt-common task-det text-center tsk-more-det">
                                        <a href="#">More</a>
                                    </div>
