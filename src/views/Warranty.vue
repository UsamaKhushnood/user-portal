    ...
    <div class="row">
        <div class="col col-12">
            ...
            <ul class="nav nav-tabs nav-justified">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#tab-2-1">Project Warranty</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#tab-2-2">Services Warranty</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="ui-block">
    <div class="your-profile">
        ...
        <div class="ststc">
            <span class="ststc-h">Project Warranty Open</span>
            <span class="c-green">100</span>
        </div>
        <div class="ststc">
            <span class="ststc-h">Project Warranty Expired</span>
            <span class="c-red">25</span>
        </div>
        <div class="ststc">
            <span class="ststc-h">Service Warranty Open</span>
            <span class="c-green">5</span>
        </div>
        <div class="ststc">
            <span class="ststc-h">Job Warranty Expired</span>
                            ...
                            <div class="task-content-row">
                                <div class="task-content ticket-prgs-common">
                                    <div class="task-ctnt-common task-icon">
                                        <img src="@/assets/img/mencap.png" class="no-radius">
                                    </div>
                                    ...
                                    <div class="task-ctnt-common task-det">
                                        <span class="stm-cont-h">Warranty</span>
                                        <span class="c-green">Valid  01.01.2021</span>
                                    </div>
